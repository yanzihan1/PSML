...
def parse_args():
    ...
    parser.add_argument('--method', default='ABNE', help='The learning method')
...
def main(args):
    ...
    if  args.method == 'ABNE':
        if args.label_file and not args.no_auto_save:
            model = pmsl_Four.ABNE(g, epoch=args.epochs, rep_size=args.representation_size, order=args.order,
